function DSXDialog(settings){
    ...
    this.dialog = $('<div id="'+this.id+'" class="dsxui-modal"></div>').css({'z-index':this.zIndex+1}).append(content);
    this.overLayer = $('<div id="dsxui-overlayer-'+dialogCount+'" class="dsxui-overlayer"></div>').css({'z-index':this.zIndex});
