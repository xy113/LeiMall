...
@section('content')
    <div class="wellcome-div">
        ...
        <a href="/member/wallet/recharge" class="button btn-recharge">我要充值</a>
    </div>
    <div class="mcenter-content-div" style="height:120px;">
        <div class="headimg-div">
            <div class="avatar"><img src="{{avatar($uid)}}"></div>
            <div class="a-setting"><a href="/member/settings/modiinfo">设置头像</a></div>
        </div>
        <div class="user-account">
            ...
            <div class="row">
                <div class="item"><a href="/member/settings/userinfo"><span class="iconfont icon-my"></span>修改个人资料</a></div>
