...
<head>
    ...
    <style type="text/css">
        ...
        .login-wrap .input-text{font-size:14px; width:260px; padding:5px 0; border-radius:2px; height:40px; line-height:40px; text-align:center; box-sizing:border-box; border:1px #CCC solid;}
...
<div class="login-wrap">
    <form method="post" id="formlogin" action="{{url('admin/checklogin')}}">
        {{csrf_field()}}
