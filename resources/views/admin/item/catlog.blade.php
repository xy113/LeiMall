...
@section('content')
    <div class="console-title">
        <a href="{{url('/admin/itemcatlog/edit')}}" class="button float-right">添加新分类</a>
        <h2>商品管理 > 分类管理</h2>
    </div>
        ...
        <form method="post" action="">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listtable">
                ...
                <tr>
                    ...
                    <td width="40">
                        <a href="{{url('/admin/itemcatlog/edit?catid='.$catid_1)}}" class="edit">编辑</a>
                        <a href="{{url('/admin/itemcatlog/delete?catid='.$catid_1)}}">删除</a>
                    </td>
                </tr>
                </tbody>
                    @if(isset($catloglist[$catid_1]))
                        ...
                        <tr>
                            ...
                            <td width="40">
                                <a href="{{url('admin/itemcatlog/edit?catid='.$catid_2)}}">编辑</a>
                                <a href="{{url('admin/itemcatlog/delete?catid='.$catid_2)}}">删除</a>
                            </td>
                        </tr>
                        </tbody>
                            @if(isset($catloglist[$catid_2]))
                                ...
                                <tr>
                                    ...
                                    <td width="60" class="align-center">
                                        <img src="{{image_url($catlog_3['icon'])}}" width="30" height="30" rel="pickimage" data-id="{{$catid_3}}">
                                    </td>
                                    <td>
                                        <div class="catlog">
                                            <div class="catlog">
                                    ...
                                    <td width="40">
                                        <a href="{{url('admin/itemcatlog/edit?catid='.$catid_3)}}">编辑</a>
                                        <a href="{{url('admin/itemcatlog/delete?catid='.$catid_3)}}">删除</a>
                                    </td>
                                </tr>
                                </tbody>
                                @endforeach
        ...
        $(function () {
            $("img[rel=pickimage]").on('click', function () {
                ...
                DSXUI.showImagePicker(function (data) {
                    ...
                    $.post("{{url('/admin/itemcatlog/seticon')}}", {catid:catid,icon:data.image});
                });
            });
        });
    </script>
